                    ...
                    <tr>
                        ...
                        <td
                            ...
                            <button class="" onclick="exibirModal('modalEditar{{ $contato->id }}')">
                                <img class="w-6 hover:brightness-50" src="{{ asset('img/edit.svg') }}" alt="editar">
                            </button>
                            <button onclick="exibirModal('modalDeletar{{ $contato->id }}')">
                                <img class="w-5 hover:brightness-50" src="{{ asset('img/delete.svg') }}" alt="deletar">
                            </button>
                        </td>
                    </tr>
                                                ...
                                                <form class="mt-5 flex flex-col gap-3"
                                                    ...
                                                    <div class="flex flex-col gap-2">
                                                        ...
                                                        <input
                                                            ...
                                                            placeholder="Digite seu nome" value="{{ $contato->nome }}">
                                                    </div>
                                                    <div class="flex flex-col gap-2">
                                                        <label for="sobrenome" class="text-base text-gray-900">Sobrenome
                                                        </label>
                                                        <input
                                                            class="bg-gray-100 border-gray-700 rounded-md px-4 py-2 focus:border-gray-100 text-black"
                                                    ...
                                                    <div class="flex flex-col gap-2">
                                                        <label for="telefone" class="text-base text-gray-900">Telefone
                                                        </label>
                                                        <input
                                                            class="bg-gray-100 border-gray-700 rounded-md px-4 py-2 focus:border-gray-100 text-black"
